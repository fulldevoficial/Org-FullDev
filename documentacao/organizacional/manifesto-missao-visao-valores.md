# Manifesto, Missao, Visao e Valores

## Manifesto FullDev

A FullDev nasceu de uma necessidade simples: desenvolvedores precisam de outros desenvolvedores para crescer.

Aprender tecnologia sozinho e possivel, mas crescer em comunidade acelera a jornada. A FullDev existe para aproximar pessoas, abrir portas, compartilhar conhecimento, gerar experiencia pratica e criar oportunidades reais para quem esta construindo carreira em tecnologia.

Somos uma comunidade criada por desenvolvedores para desenvolvedores.
...
Acelerar carreiras em tecnologia por meio de networking, conhecimento, oportunidades, eventos, projetos colaborativos e experiencias reais de mercado.
...
- Comunidade primeiro: decisoes devem fortalecer a experiencia dos membros.
- By Dev, For Dev: a comunidade deve ser conduzida com participacao real de desenvolvedores.
...
## O que a FullDev nao e

- Nao e espaco para discriminacao, assedio, humilhacao ou gatekeeping.
- Nao e canal de spam, autopromocao abusiva ou venda predatoria.
- Nao e palanque individual de liderancas.
- Nao e uma rede de grupos independentes usando o mesmo nome.
- Nao e uma operacao que depende de uma unica pessoa para funcionar.
...
- Beneficio: cria uma narrativa unica para membros, lideres, parceiros e patrocinadores.
- Beneficio: diferencia comunidade, escola, plataforma e nucleos regionais dentro de um mesmo ecossistema.
- Risco: uma visao muito ampla pode dispersar foco.
- Trade-off: a FullDev deve priorizar algumas frentes por fase, mesmo mantendo a visao completa.
