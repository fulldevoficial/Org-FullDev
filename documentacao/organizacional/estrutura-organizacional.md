...
Este e o modelo de longo prazo. No momento atual, a FullDev deve operar com foco em FullDev School e pagina de links, mantendo os demais blocos como arquitetura futura.
...
|   |-- Comunicacao
|   |-- Eventos
|   |-- Educacao / FullDev School
|   |-- Plataforma / FullDev Platform
...
- Direcao de Educacao: governa FullDev School, trilhas, instrutores e criterios pedagogicos.
- Direcao de Plataforma: governa FullDev Platform, produto, dados, moderacao digital e roadmap.
- Direcao de Parcerias: organiza empresas, universidades, coworkings e patrocinadores.
- Direcao de Comunicacao: marca, conteudo, redes sociais, newsletter e campanhas.
- Operacoes: processos, checklists, documentos, calendarios e indicadores.
...
- Lider regional.
- Vice-lider ou co-lider.
- Responsavel por comunidade.
- Responsavel por comunicacao.
...
A FullDev School nao e um nucleo como os outros. Ela e um produto/frente educacional da FullDev Central.

Isso muda sua governanca: a School deve ser conduzida pela Central, com coordenacao educacional, criterios pedagogicos, parceiros academicos e indicadores proprios.

## Nivel 3: Frentes Operacionais

### Comunidade

Cuida de grupos, moderacao, acolhimento, engajamento, rituais e encaminhamento de conflitos.
...
Cuida de meetups, workshops, palestras, encontros presenciais, hackathons locais e experiencia dos participantes.

### Parcerias

Cuida de universidades, empresas, coworkings, comunidades amigas e patrocinadores locais.
...
- Criacao de canais oficiais publicos.
...
- Beneficio: escala operacao local sem exigir que o fundador aprove cada detalhe.
- Beneficio: torna facil abrir, avaliar e encerrar nucleos.
- Risco: excesso de burocracia pode desmotivar voluntarios.
- Trade-off: a FullDev deve manter poucas regras obrigatorias, mas aplica-las com rigor.
