...
### Status atual informado em junho de 2026

- Projetos ativos: FullDev School e pagina de links.
...
- Documentacao basica: historia, manifesto inicial, links para cartilha de moderacao, cartilha do conselho e organograma externo.
- Projetos e iniciativas historicas: FullDev School, FullDev Online, FullDev Games, FullDev Links, FullDev Atta, FullDev Meetup, FullDev Meruem, CodeQueens, RainbowStack e FullDev Strong.
- Produto/plataforma: documentos de visao, escopo, MVP e indicador de cursos para FullDev Online, atualmente desativado.
- Educacao: FullDev School possui proposta mais madura, com trilhas, coordenacao, instrutores, hosts, calendario e modelo de transmissao.
- Eventos e comunidade: existem referencias a hackathons, meetups, grupos de WhatsApp/Discord e subcomunidades.

### Processos documentados

- Planejamento de sprint para FullDev Online, como registro historico.
- Moderacao previa de conteudo na proposta historica da plataforma.
- Revisao de marcas/instituicoes no indicador de cursos, como proposta historica.
- Modelo inicial de aulas gratuitas na FullDev School.
- Cronograma de MVP para FullDev Games.

### Papeis atuais identificados

- Fundador: ideacao e palavra final em caso de nao aprovacao pelo conselho.
- Conselho: ideacao, organizacao e decisao.
- Moderacao: ideacao e gestao de grupos.
- Membros: consumidores finais.
- Coordenacao de projeto: aparece em School, Online e Games.
- Hosts, instrutores, auxiliares, designers e pessoas tecnicas aparecem em iniciativas especificas.
...
4. [Equipe FullDev School](equipe-fulldev-school.md)
5. [Estrategia do Discord](estrategia-discord.md)
6. [Comunidades Parceiras](comunidades-parceiras.md)
7. [Guia de Eventos](guia-de-eventos.md)
8. [Estrategia de Aquisicao de Membros](estrategia-aquisicao-membros.md)
9. [Estrategia de Instagram](estrategia-instagram.md)
10. [Modelo de Governanca](governanca.md)
11. [Codigo de Conduta](codigo-de-conduta.md)
12. [Manual dos Lideres Regionais](manual-lideres-regionais.md)
13. [Processo de Criacao de Nucleos Regionais](criacao-de-nucleos-regionais.md)
14. [Portfolio Atual e Status dos Projetos](portfolio-atual.md)
15. [FullDev School e Projeto de Extensao PUC Minas](fulldev-school-projeto-extensao.md)
16. [Roteiro de Perguntas e Decisoes](roteiro-perguntas-decisoes.md)
17. [Politicas de Eventos, Parcerias e Patrocinio](politicas-eventos-parcerias-patrocinio.md)
18. [Playbook Operacional e Comunicacao Interna](playbook-operacional-comunicacao.md)
19. [Tomada de Decisao e Escalabilidade](decisao-escalabilidade.md)
